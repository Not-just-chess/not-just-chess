class Game < ApplicationRecord
  ...
  def populate_game
    ...
    Rook.create(game_id: @game.id, y_position: 1, x_position: 1, color: false)
    Rook.create(game_id: @game.id, y_position: 1, x_position: 8, color: false)
    Knight.create(game_id: @game.id, y_position: 1, x_position: 2, color: false)
    ...
    Rook.create(game_id: @game.id, y_position: 8, x_position: 1, color: true)
    Rook.create(game_id: @game.id, y_position: 8, x_position: 8, color: true)
    Knight.create(game_id: @game.id, y_position: 8, x_position: 2, color: true)
