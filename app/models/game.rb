class Game < ApplicationRecord
  ...
  def populate_game
    ...
    King.create(game_id: @game.id, y_position: 1, x_position: 4, color: true)
    Queen.create(game_id: @game.id, y_position: 1, x_position: 5, color: true)
    ...
    King.create(game_id: @game.id, y_position: 8, x_position: 4, color: false)
    Queen.create(game_id: @game.id, y_position: 8, x_position: 5, color: false)
  end
end
